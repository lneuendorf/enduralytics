...
WEEKLY_COLUMNS = [
    ...
    {"key": "tss_per_hour", "label": "TSS/hr", "align": "end",
     "sort": lambda w: ((w.get("total_tss") or 0) / w["total_hours"]) if w.get("total_hours") else 0,
     "render": lambda w: f"{(w.get('total_tss') or 0) / w['total_hours']:.0f}" if w.get("total_hours") else "\u2014"},
